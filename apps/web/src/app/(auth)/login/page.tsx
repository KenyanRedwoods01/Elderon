...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Sign in to your account to continue your enterprise transformation
            </p>
          </div>
          ...
          >
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-enterprise-blue hover:text-blue-500">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/register" className="font-medium text-enterprise-blue hover:text-blue-500">
                  Sign up for free
                </Link>
              </p>
            </div>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-enterprise-blue to-enterprise-purple">
          ...
          <div className="max-w-md text-center text-white">
            ...
            >
              ...
              <p className="text-xl mb-8 text-blue-100">
                AI-powered system modernization that delivers results. Join thousands of enterprises already using ElderonAI.
              </p>
